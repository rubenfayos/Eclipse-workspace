...
public class Datos{
	...
	public void getProductosCategoria(int categoria) {
		
		System.out.println("Lista de los productos de la categoria " + categorias.get(categoria-1).getNombre() + ": ");
		
		for(Producto producto:this.productos) {
			
			if(producto.getCategoria() == categorias.get(categoria-1)) {
			
				System.out.print("Id: " + producto.getId() + ", nombre: " + producto.getNombre() + ", precio: " + producto.getPrecio());
